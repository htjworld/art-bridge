...
| \<"종로구에서 이번 주 볼만한 연극 추천해주고 예매 링크도 알려줘" 응답 화면\> | \<"요즘 뮤지컬 뭐가 제일 핫해? 출연진이랑 예매 링크도 알려줘" 응답 화면\> | \<"이번 달 마감 임박한 공연 중에 놓치면 아까운 거 뭐야?" 응답 화면\> |
|---|---|---|
| <img src="./assets/search.png" alt="search" height="600" /> | <img src="./assets/trending.png" alt="trending" height="600" /> | <img src="./assets/deadline.png" alt="deadline" height="600" /> |
...
```
https://art-bridge.onrender.com/mcp
```
...
카카오 MCP 공모전 'MCP Player 10' Top 3 수상 · PlayMCP 추천순·툴콜순 전체 1위 · 누적 툴콜 1만 건+
